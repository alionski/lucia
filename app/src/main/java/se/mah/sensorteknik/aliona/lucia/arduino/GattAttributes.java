...
public class GattAttributes {
    ...
    public static String VIBRATION_CHARACTERISTIC_UUID = "c88f5ba0-dee3-4d6c-8e33-38ad5261cc85"; // NOT NEEDED
    public static String PROXIMITY_READINGS_CHARACTERISTC_UUID = "b4ded119-98a3-4a4c-a001-015ce5142cc1"; // if the proximity sensor should be on or off.
